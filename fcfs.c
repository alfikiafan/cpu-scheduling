...
int main() {
    // AT     =  Arrival Time,         WT     =  Waiting Time,            TAT   =  Turn Around Time
    // n      =  banyak proses,        b      =  burst time,              name  =  nama proses,
    // TotWT  =  Total Waiting Time,   TotTA  =  Total Turn Around time,
    // AvWT   =  Average Waiting Time, AvTA   =  Average Turn Around time
